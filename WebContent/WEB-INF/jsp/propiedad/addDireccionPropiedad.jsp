...
<t:paginabasica title="Nueva dirección">
	...
	<form:form method="post" modelAttribute="nuevaDireccionPropietario">
		<table class="table table-condensed">
			...
			<tr>
 				<td>
 				<a class="btn btn-primary" href="${pageContext.request.contextPath}/propiedad/finalizarAnadirPropiedad.html">Finalizar</a>
