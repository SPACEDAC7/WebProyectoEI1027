...
<t:paginabasica title="Actualizar credencial">
	<jsp:body>
		...
		<div class="page-title"><a href="${pageContext.request.contextPath}/credencial/list.html"><i class="icon-custom-left"></i></a>
			<h3>Credenciales - <span class="semi-bold">Modificar credencial</span></h3>
		</div>
		 <div class="row">
		...
		<form:form class="form-horizontal col-md-8 col-xs-8" method="post" modelAttribute="credencial">
			<table class="table table-condensed">
				...
				<tr>
 				<td><input class="btn btn-primary btn-cons" type="submit" value="Actualizar Credencial" /></td>
